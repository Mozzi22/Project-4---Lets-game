...
export enum actionTypes{
    ...
    START_STATISTICS_REQUEST = '@@game/START_STATISTICS_REQUEST',
    GET_STATISTICS_SUCCESS = '@@game/GET_STATISTICS_SUCCESS',
    GET_STATISTICS_ERROR = '@@game/GET_STATISTICS_ERROR',
}
