export enum actionTypes{
    ...
    SET_CURRENT_CHECKER = '@@game/SET_CURRENT_CHECKER',
    SET_CHECKER_DESK = '@@game/SET_CHECKER_DESK',
    ...
    GET_POSSIBLE_STEP = '@@game/GET_POSSIBLE_STEP',
    PUT_POSSIBLE_STEPS = '@@game/PUT_POSSIBLE_STEPS',
    DO_CHECKER_STEP = '@@game/DO_CHECKER_STEP',
    SET_WINNER = '@@game/SET_WINNER',
    GET_STATISTICS = '@@game/GET_STATISTICS',
    SET_STATISTICS_SUCCESS = '@@game/GET_STATISTICS_SUCCESS',
    LOG_OUT = '@@game/LOG_OUT',
}
